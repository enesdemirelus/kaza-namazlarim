    ...
    <div className="h-svh flex flex-col items-center justify-between py-8 px-4">
      <div className="w-full max-w-sm flex flex-col gap-5">
        ...
        <div className="grid grid-cols-3 gap-2">
          {([
            { Icon: BookOpen, title: t("features.trackTitle"), desc: t("features.trackDesc") },
            { Icon: Clock,    title: t("features.timesTitle"), desc: t("features.timesDesc") },
            { Icon: CheckCircle2, title: t("features.stayTitle"), desc: t("features.stayDesc") },
          ] as const).map(({ Icon, title, desc }) => (
            <div key={title} className="flex flex-col items-center gap-1.5 rounded-2xl bg-primary/5 border border-primary/10 p-3 text-center">
