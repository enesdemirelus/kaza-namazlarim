...
export default async function Home() {
  ...
  return (
    <main className="flex-1 flex flex-col gap-3 p-4 md:grid md:grid-cols-[1fr_1fr] md:gap-4 md:p-6">
      <PrayerTimesWidget />
      <div className="flex-1 flex flex-col gap-3 md:grid md:grid-rows-2 md:gap-4">
